...
Write a program that extends the program session8LinkedList.c by an additional option
“0” which shows after selection the number of values of the list which are smaller than
an entered limit. If the list is empty the message “List is empty!” should appear. Otherwise
the message “No. of values in the list which are smaller than [L] is: [N]” should appear
where L is the entered limit and N the number of values in the list which are smaller than
[L]. The picture below shows an example.
...
void printBiggerValuesThan(int num);
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("0. Find Num. of smaller values than: \n");
        printf("1. Insert \n");
        printf("2. Display \n");
        printf("3. Size \n");
        printf("4. Delete \n");
        ...
        {
        case 0:
            printf("\nEnter upper comparison limit: ");
            scanf("%d", &num);
            printBiggerValuesThan(num);
            break;
        case 1:
...
void printBiggerValuesThan(int num)
{
    ...
    // no value found
    printf("\n Num. of values in the list which are smaller than %d is: %d \n", num, smallerValues);
}
