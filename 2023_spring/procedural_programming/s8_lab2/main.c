...
“0” which shows after selection the number of values of the list which are bigger than an
entered limit. If the list is empty the message “List is empty!” should appear. Otherwise
the message “No. of values in the list which are bigger than [L] is: [N]” should appear
where L is the entered limit and N the number of values in the list which are bigger than
...
int main()
{
    ...
    while (1)
    {
        ...
        printf("0. Find Num. of bigger values than: \n");
        printf("1. Insert \n");
        printf("2. Display \n");
        printf("3. Size \n");
        printf("4. Delete \n");
...
void printBiggerValuesThan(int num)
{
    ...
    // no value found
    printf("\n Num. of values in the list which are bigger than %d is: %d \n", num, values);
}
